...
<tr>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<td>	
		<select style="height: 40px; width: 190px;"  class="styledselect_form_1" name="category">
		...
		<td>	
		<select style="height: 40px; width: 190px;"  class="styledselect_form_1" name="season">
...
<script type="text/javascript">
	...
	<tr>
		...
		<td>	
		<select style="height: 40px; width: 190px;" class="styledselect_form_1" name="visible">

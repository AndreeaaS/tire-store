...
?>
 <div class="center__catalog-index">
				...
				<h1 style="font-family: Verdana, sans-serif; color: #0067AE; font-weight: normal;">Распродажа</h1>
				<?php if($eyestoppers): ?>
               ...
               <!-- <div class="catalog-index__product">
					<h2><a href="#">MATADOR MP 30 SIBIR ICE2</a></h2>
					<a href="#"><img src="<?=TEMPLATE?>images/shina-1.jpg" alt=""></a>
					<p>Цена: <span>24 990. </span></p>
					<a href="#"><img class="product__addtocart-index" src="<?=TEMPLATE?>images/addcard-index.jpg" alt="Добавить в корзину"></a>
				</div>
				<div class="catalog-index__product">
					<h2><a href="#">MATADOR MP 30 SIBIR ICE2</a></h2>
					<a href="#"><img src="<?=TEMPLATE?>images/shina-1.jpg" alt=""></a>
